...
public class BoulePuissante extends Objet implements Global{
	
	private JeuServeur jeuServeur;
	
	public BoulePuissante(JeuServeur jeuServeur){
		...
		super.label.getjLabel().setIcon(new ImageIcon(BOULEPUISSANTE));
